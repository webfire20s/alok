...
<head>
        ...
        <script>
            window.FleetCart = {
                ...
                rtl: false,
                storeName: 'Ajanta Bottle Pvt Ltd -',
...
<div class="head-inform-bar" style="background-color: FED8B1"><p style="color: 000000"><p>The minimum order value is only Rs 15,000/- now!&nbsp;</p></p></div>
  ...
  <!-- Navigation Start -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark only-desktop">
        ...
        <div class="collapse navbar-collapse justify-content-md-center ss2" id="navbarsExample08">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="javascript:void(0);"> Shop By Industry </a>
                ...
                <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="javascript:void(0);"> Shop By Product </a>
