...
<head>
    ...
    <style>
        ...
        body, html, p, a, li, span, label, input, button {
        ...
        /* Subtle styling additions to refine structural elements elegantly */
        a {
            transition: color 0.2s ease-in-out, background-color 0.2s ease-in-out;
        }

        /* Refined primary button layout to match corporate branding */
        ...
        .btn-primary:hover, .btn-main:hover {
            ...
            border-color: #2c323e !important;
            transform: translateY(-1px);
        }
    </style>

       
		<style>/* Critical Path CSS Generated by Pegasaas Accelerator at https://pegasaas.com/ for https://www.ajantabottle.com */
        ...
        })(window,document,'script','dataLayer','GTM-WS57X8K');</script>
...
>
    ...
    <div class="head-inform-bar" style="background-color: #f7d3b5; border-bottom: 1px solid #d4dcec; padding: 10px 0; text-align: center;">
        <p style="color: #c8232c; font-weight: 600; margin: 0; font-size: 13px; letter-spacing: 0.03em; text-transform: uppercase;">
            The minimum order value is only Rs 15,000/- now!
        </p>
    </div>

    <header style="background-color: #ffffff; padding: 20px 0;">
        <div class="container">
            <div class="row" style="align-items: center;">
                <div class="col-md-4 txtm-center only-desktop">
                    <div style="display: flex; align-items: center; gap: 24px;">
                        ...
                        <!-- Fine divider to separate the structural logos professionally -->
                        <div style="height: 50px; width: 1px; background-color: #e2e4e8;"></div>

                        <a href="index.php" style="display: inline-block; filter: grayscale(1) contrast(1.1); opacity: 0.85;">
                            <img
                ...
                <div class="col-12 text-left only-mobile">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light" style="padding: 10px 0; background: #ffffff;">
                        ...
                        <div class="d-flex align-items-center" style="gap: 12px; max-width: 70%;">
                            ...
                            <a href="index.html" style="display: inline-block; filter: grayscale(1) contrast(1.1); opacity: 0.85;">
                        ...
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample08" aria-controls="navbarsExample08" aria-expanded="false" aria-label="Toggle navigation" style="border: none; background: transparent; padding: 4px 0;">
                        ...
                        <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
                            <ul class="navbar-nav" style="padding-top: 15px;">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" id="dropdown08" href="javascript:void(0);" aria-haspopup="true" aria-expanded="false" style="font-weight: 500; color: #11141a;"> Shop By Industry </a>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdown08" style="border: none; background-color: #f8f9fa; border-radius: 4px; box-shadow: none; padding-left: 15px;">
                                        <?php foreach($navCategories as $cat): ?>
                                            <a
                                                class="dropdown-item"
                                                href="category/<?= urlencode($cat['slug']) ?>"
                                                style="font-size: 14px; padding: 8px 0; color: #2c323e;"
                                            >
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" id="dropdown08_prod" href="javascript:void(0);" aria-haspopup="true" aria-expanded="false" style="font-weight: 500; color: #11141a;"> Shop By Product </a>
                                        
                                    <div class="dropdown-menu" aria-labelledby="dropdown08_prod" style="border: none; background-color: #f8f9fa; border-radius: 4px; box-shadow: none; padding-left: 15px;">
                                        <?php foreach($navCategories as $cat): ?>
                                            <a
                                                class="dropdown-item"
                                                href="category/<?= urlencode($cat['slug']) ?>"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="decoration-services.php" style="font-weight: 500; color: #11141a;">
                                        Decoration Services
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="category.php?slug=akikai-packaging-machines" style="font-weight: 500; color: #11141a;">
                                        Akikai Packaging Machines
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="category.php?slug=colour-cosmetics-packaging" style="font-weight: 500; color: #11141a;">
                                        Colour Cosmetics Packaging
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="blogs.php" style="font-weight: 500; color: #11141a;">
                                        Blogs and Videos
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="contact.php" style="font-weight: 500; color: #11141a;">
                                        Contact Us
                                    </a>
                                </li>
...
<!-- Header Ends -->
  ...
  <nav class="navbar navbar-expand-lg only-desktop" style="background-color: #11141a; padding: 0; border-bottom: 3px solid #1a1e26;">
        ...
        <div class="collapse navbar-collapse justify-content-md-center ss2" id="navbarsExample08">
            ...
            <ul class="navbar-nav" style="gap: 4px; padding: 0; margin: 0;">

                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0);" style="font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 13px; uppercase !important; letter-spacing: 0.04em; color: #ffffff; padding: 16px 20px; transition: background-color 0.2s ease;"> Shop By Industry </a>
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown08" style="margin: 0; border: none; border-radius: 0 0 4px 4px; background-color: #ffffff; box-shadow: 0 8px 24px rgba(0,0,0,0.12); padding: 8px 0;">
                        <?php foreach($navCategories as $cat): ?>
                            <a
                                class="dropdown-item"
                                href="category/<?= urlencode($cat['slug']) ?>"
                                style="font-family: 'Montserrat', sans-serif; font-size: 13px; font-weight: 500; color: #2c323e; padding: 10px 20px; transition: all 0.2s ease;"
                                onmouseover="this.style.backgroundColor='#f7f5f0'; this.style.color='#11141a';"
                                onmouseout="this.style.backgroundColor='transparent'; this.style.color='#2c323e';"
                            >
                                <?= htmlspecialchars($cat['name']) ?>
                            </a>
                        <?php endforeach; ?>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0);" style="font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 13px; uppercase !important; letter-spacing: 0.04em; color: #ffffff; padding: 16px 20px; transition: background-color 0.2s ease;"> Shop By Product </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="decoration-services.php" style="font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 13px; uppercase !important; letter-spacing: 0.04em; color: #ffffff; padding: 16px 20px; transition: background-color 0.2s ease;">
                        Decoration Services
                    </a>
                </li>

                /* <li class="nav-item">
                    <a class="nav-link" href="category.php?slug=akikai-packaging-machines" style="font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 13px; uppercase !important; letter-spacing: 0.04em; color: #ffffff; padding: 16px 20px; transition: background-color 0.2s ease;">
                        Akikai Packaging Machines
                    </a>
                </li> */

                <li class="nav-item">
                    <a class="nav-link" href="category.php?slug=colour-cosmetics-packaging" style="font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 13px; uppercase !important; letter-spacing: 0.04em; color: #ffffff; padding: 16px 20px; transition: background-color 0.2s ease;">
                        Colour Cosmetics Packaging
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="blogs.php" style="font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 13px; uppercase !important; letter-spacing: 0.04em; color: #ffffff; padding: 16px 20px; transition: background-color 0.2s ease;">
                        Blogs and Videos
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="contact.php" style="font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 13px; uppercase !important; letter-spacing: 0.04em; color: #ffffff; padding: 16px 20px; transition: background-color 0.2s ease;">
                        Contact Us
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="track-order.php" style="font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 13px; uppercase !important; letter-spacing: 0.04em; color: #ffffff; padding: 16px 20px; transition: background-color 0.2s ease;">
                        Track Order
                    </a>
                </li>
        ...
        <!--<li class="nav-item dropdown">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="dropdown08" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Shop By Industry</a>

            <div class="dropdown-menu" aria-labelledby="dropdown08">

            <a class="dropdown-item" href="#">Link 01</a>

            <a class="dropdown-item" href="#">Link 02</a>

            <a class="dropdown-item" href="#">Link 03</a>
      ...
      <!--<li class="nav-item">
        ...
        <a class="nav-link" href="#">Decoration Services</a>
