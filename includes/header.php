...
<head>
    ...
    <style>
        ...
        .mobile-subcategory .dropdown-item{
            font-size:13px;
            color:#666;
            padding:8px 15px;
        }
        ...
        .mobile-category-toggle.open span{
        ...
        .mobile-single-category:hover{
            background:#fff4f4;
            color:#c8232c;
        }

        /* MOBILE-ONLY OVERRIDES FOR SEARCH WRAPPER */
        @media (max-width: 767.98px) {
            ...
            .search-wrap-update .input-group {
                flex-wrap: nowrap !important;
            }

            .search-wrap-update input[name="q"] {
                font-size: 12px !important;
    ...
    <script>
        document.addEventListener("DOMContentLoaded",function(){
            ...
            // Main Shop By Product
            const mainBtn=document.querySelector(".mobile-main-toggle");
            ...
            if(mainBtn){
                ...
                mainBtn.addEventListener("click",function(e){
                    ...
                    document
                    .querySelector(".mobile-product-menu")
                    .classList
                    .toggle("open");
