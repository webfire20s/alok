...
<style>
    ...
    .alok-social-wrapper a {
        ...
        color: #ffffff !important; /* Forces vector fallback color balance */
    }
...
<div class="container-fluid text-center p-3 alok-copyright-bar">
    <ul class="footer-copyright">
        <li>Alok Glass Works. All Rights Reserved</li>
    </ul>
</div>
